<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="OthersProfile.aspx.cs" Inherits="l144210.OthersProfile" %>
    ...
    <div class="cover">
        <div class="prof-pic-up">
            <div style="float:right;margin-top:60px;margin-right:90px">
                    <asp:Button ID="Follow" CssClass="signup-button" OnClick="btnFollowUnfollow" Text="Follow" runat="server"/>
            </div>
        </div>
        <table>
            <tr>
                        ...
                        <tr>
                            <td>
                                <div class="all-tweets">
                                    ...
                                    <div  class="abbu">
                                        <span><a href="Profile.aspx?Email=<%# Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))+1,int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))-1) %>"><strong><asp:Label ID="Label1" runat="server" Text=" <%# Container.DataItem.ToString().Substring(0,int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))) %>"></asp:Label></strong> </a>
                                        <a href="Profile.aspx?Email=<%# Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))+1,int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))-1) %>" style="color:#808080"><small><asp:Label ID="Label2"  runat="server" Text="<%# Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))+1,int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-4,2))-1)  %>"></asp:Label></small> </span></a>
                                        <br />
