<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="l144210.Messages" %>
        ...
        <form id="form5" class="tweet-form" runat="server">
            <div class="span8">
                <div class="cols threecols tweets">
                    <center class="font-color"><h4>Your Conversations with <asp:Label runat="server" ID="bnda"></asp:Label></h4>
                    <span class="font-color">Send A New Message</span></center><br />
                    <div class="tweet-box">
                        <img class="tweet-image" src="img/dp/purple.jpg"/>
                        <asp:TextBox ID="MessageContent1" runat="server" placeholder="Come Home Johnny ..." style="margin-left:50px;width:450px"/>
                        <asp:ImageButton class="tweet-image" src="img/logo/reply-message.png" style="margin-top:3px" runat="server" OnClick="SendMessage"/>         
                    </div>
