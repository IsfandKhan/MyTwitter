<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Followship.aspx.cs" Inherits="l144210.Followship" %>
            ...
            <div class="span3">
             ...
             <div class="span8">
                 <div class="cols threecols tweets">
                    <h4 style="margin-left:20px"><asp:Label runat="server" ID="TypePressed" Text="People" /></h4>
                            ...
                            <tr>
                                <td>
                                    <div class="all-tweets">
                                        ...
                                        <div  class="abbu">
                                            <span><a href='<%#string.Concat("~/OthersProfile.aspx?Email=", Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))+1,(Container.DataItem.ToString().Length-3)-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))))  %>' runat="server"><strong><asp:Label ID="Label1" runat="server" Text="<%# Container.DataItem.ToString().Substring(0,int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))) %>"></asp:Label></strong> </a>
                                            <br />
