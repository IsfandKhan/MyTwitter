<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Trends.aspx.cs" Inherits="l144210.Trends" %>
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="cols">
                                ...
                                <table class="overlay-info">
                                    <tr>
                                        <td><a href="Profile.aspx"><span style="font-size:small;margin-bottom:0;">
                                            <asp:Label ID="PersonName" runat="server" Text="UserName"></asp:Label></span></a>
                                        <br />
                                        <span style="color:#A0A0A0;font-size:smaller"><asp:Label ID="PersonEmail" runat="server" Text="@username"></asp:Label></span></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <div class="prof-pic-down">
                        <h3 class="font-color"><asp:Label ID="TrendsTotalTweets" runat="server"></asp:Label> Tweets</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="cols threecols font-color">
                    <h4 >Top Trends</h4>
                    <asp:Repeater ID="ShowTopTrends" runat="server">
                        <ItemTemplate> 
                            <tr>
                                <td><asp:HyperLink ID="TrendLink1" runat="server" NavigateUrl='<%#String.Concat("~/Trends.aspx?TrendName=", Container.DataItem.ToString().Substring(1,Container.DataItem.ToString().Length-1))%>' Text="<%# Container.DataItem %>"></asp:HyperLink><br /></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </div>
        ...
        <div class="span8">
            <div class="cols threecols tweets">
                <asp:Repeater ID="RepeatTweets" runat="server">
                    <ItemTemplate> 
                        <tr>
                            <td>
