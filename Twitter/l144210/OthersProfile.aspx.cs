...
namespace l144210
{
    public partial class OthersProfile : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String Email = Request.QueryString["Email"];
            String ChkEmail = Session["DataEmail"].ToString();
            if(Email==ChkEmail)
            {
            ...
            int found = 0;
            found = objMyDal.CheckFollow(Email,ChkEmail, ref DT);
            ...
            this.Repeater2.DataSource = Tweeting1;
            ...
            DataSet WhoFollow = objMyDal.FriendFollow(ChkEmail);
            ...
            DataSet Followers = objMyDal.GetFollowers(ChkEmail);
        ...
        protected void btnFollowUnfollow(object sender, EventArgs e)
        {

            String Email = Request.QueryString["Email"];
            String ChkEmail = Session["DataEmail"].ToString();
            myDAL objMyDal = new myDAL();
            objMyDal.FollowUnfollow(Email,ChkEmail);
            Response.Redirect("OthersProfile.aspx?Email="+Email);
        }
        //
