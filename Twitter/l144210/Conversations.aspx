<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="Conversations.aspx.cs" Inherits="l144210.Conversations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="header" runat="server">
    ...
    <li class="active"><a onclick="document.getElementById('lightbox').style.display='inline';"  data-toggle="tab"><img src="img/logo/messages.png" width="23" height="15"/> Messages</a></li>
        ...
        <form id="form5" class="tweet-form" runat="server">
            <div class="span8">
                <div class="cols threecols tweets">
                    <center class="font-color"><h3>Your Conversations</h3>
                    <span class="font-color">Click On a Conversation to View Messages</span></center><br />
                                        ...
                                        <div  class="abbu">
                                            <span>
                                                ...
                                                <span style="float:right">
                                                    <a href='<%#string.Concat("~/Messages.aspx?Email=", Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))+1,(Container.DataItem.ToString().Length-3)-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))))  %>' runat="server"><img style="margin-top:5px;"  src="img\logo\reply-message.png" width="40" height="40"/></a>
                                                </span><br />
                                                <span><a href='<%#string.Concat("~/OthersProfile.aspx?Email=", Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))+1,(Container.DataItem.ToString().Length-3)-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))))  %>' runat="server" style="color:#A0A0A0;font-size:small"><strong><asp:Label ID="Label2" runat="server" Text="<%# Container.DataItem.ToString().Substring(int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))+1,(Container.DataItem.ToString().Length-3)-int.Parse(Container.DataItem.ToString().Substring(Container.DataItem.ToString().Length-2,2))) %>"></asp:Label></strong> </a></span>
                                            </span>
                                            <br />
                                            <br />
                                        </div>
